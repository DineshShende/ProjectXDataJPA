...
public class FreightRequestByVendorWithRequiredAllocationStatus {
	...
	private FreightRequestByVendorDTO freightRequestByVendor;
	...
	public FreightRequestByVendorWithRequiredAllocationStatus(String status,
			FreightRequestByVendorDTO freightRequestByVendor) {
		super();
		this.status = status;
	...
	public FreightRequestByVendorDTO getFreightRequestByVendor() {
