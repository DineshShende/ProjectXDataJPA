...
public class CustomerQuickRegisterEntityDataFixture {
	...
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, CUST_MOBILE, CUST_PIN, CUST_ISEMAIL_VERIFIED, CUST_ISMOBILE_VERIFIED,CUST_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME, CUST_UPDATED_BY);
		
	}
	
	public static QuickRegisterEntity standardMobileCustomer()
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, null, CUST_MOBILE, CUST_PIN, null, CUST_ISMOBILE_VERIFIED,CUST_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME, CUST_UPDATED_BY);
		
	}
	
	public static QuickRegisterEntity standardEmailCustomer()
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, null, CUST_PIN, CUST_ISEMAIL_VERIFIED, null,CUST_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME, CUST_UPDATED_BY);
